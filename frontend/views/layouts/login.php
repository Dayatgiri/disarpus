...
<head>
    ...
    <!-- Favicons -->
     ...
     <!-- <link rel="icon" href="../uploaded_files/aplikasi/favicon.png" type="image/x-icon"/> -->
    <?php $this->head() ?>
</head>
<body>
<?php $this->beginBody() ?>
   ...
   <header class="main-header">
        <nav class="navbar navbar-static-top">
          <div class="container">
              ...
              <div class="title">
                    <div class="image">
                        <a href='<?=$homeUrl?>'> <img src="<?= Yii::$app->urlManager->createUrl('../uploaded_files/aplikasi/logo_perpusnas_2015.png') ?>" class="img-logo" height="65" width="70"> </a>
                         <?php 
                         //yii\helpers\Html::img(Url::base().'/'.Url::to('assets_b/img/logo.png'), ['alt'=>'Logo Keanggotaan Online Inlislite', 'class'=>'img-logo', ]) ?>
            ...
            <!-- Navbar Right Menu -->
            <div class="collapse navbar-collapse pull-right mt-1" id="navbar-collapse">
                    ...
                    <li> <a class="bookmarkShow" href="javascript:void(0)"  onclick='tampilBooking()' ></a> </li>     
                      ...
                      if (Yii::$app->user->isGuest) {
                        echo"
                        <li > <a href=\"../".Url::to('../')."\">" .Yii::t('app', 'Kembali')."</a> </li>
                        ";
                      } else {
                        echo"
