...
$this->title = Yii::t('app', 'PERPUSTAKAAN');
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                ...
                echo \inliscore\adminlte\widgets\SmallBox::widget([
                    ...
                    'head'=>$count,
                    'text'=> Yii::t('app', 'Sejarah Peminjaman'),
                    'icon'=>'fa fa-book',
                    'footer'=>'Detail <i class="fa fa-hand-o-right"></i>',
                    'footer_link'=>'daftar-pengembalian'
                ]);?>
            ...
            <!-- <div class="col-md-3 col-sm-6 col-xs-12">
                ...
                echo \inliscore\adminlte\widgets\SmallBox::widget([
                    ...
                    'icon'=>'fa fa-book',
                    'footer'=>'Detail <i class="fa fa-hand-o-right"></i>',
                    'footer_link'=>'daftar-pelanggaran'
                ]);?>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                ...
                echo \inliscore\adminlte\widgets\SmallBox::widget([
                    'type'=>\inliscore\adminlte\widgets\SmallBox::TYPE_RED,
                    'head'=>'PINJAM ',
                    'text'=> 'BUKU ONLINE',
