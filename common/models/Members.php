...
class Members extends BaseMembers
{
    ...
    public function rules()
    {
        return [
           ...
           [['Phone', 'IdentityNo', 'MotherMaidenName', 'Email', 'CreateTerminal', 'UpdateTerminal', 'NoHp', 'NamaDarurat', 'TelpDarurat', 'StatusHubunganDarurat', 'Kecamatan', 'Kelurahan', 'KecamatanNow', 'KelurahanNow'], 'string', 'max' => 100],
            ...
            [['JenisPermohonan_id'], 'exist', 'skipOnError' => true, 'targetClass' => JenisPermohonan::class, 'targetAttribute' => ['JenisPermohonan_id' => 'ID']],
            [['StatusAnggota_id'], 'exist', 'skipOnError' => true, 'targetClass' => StatusAnggota::class, 'targetAttribute' => ['StatusAnggota_id' => 'id']],
            [['MaritalStatus_id'], 'exist', 'skipOnError' => true, 'targetClass' => MasterStatusPerkawinan::class, 'targetAttribute' => ['MaritalStatus_id' => 'id']],
            [['Agama_id'], 'exist', 'skipOnError' => true, 'targetClass' => Agama::class, 'targetAttribute' => ['Agama_id' => 'ID']],
            [['EducationLevel_id'], 'exist', 'skipOnError' => true, 'targetClass' => MasterPendidikan::class, 'targetAttribute' => ['EducationLevel_id' => 'id']],
            [['Fakultas_id'], 'exist', 'skipOnError' => true, 'targetClass' => MasterFakultas::class, 'targetAttribute' => ['Fakultas_id' => 'id']],
            [['IdentityType_id'], 'exist', 'skipOnError' => true, 'targetClass' => MasterJenisIdentitas::class, 'targetAttribute' => ['IdentityType_id' => 'id']],
            [['JenisAnggota_id'], 'exist', 'skipOnError' => true, 'targetClass' => JenisAnggota::class, 'targetAttribute' => ['JenisAnggota_id' => 'id']],
            [['Job_id'], 'exist', 'skipOnError' => true, 'targetClass' => MasterPekerjaan::class, 'targetAttribute' => ['Job_id' => 'id']],
            [['Jurusan_id'], 'exist', 'skipOnError' => true, 'targetClass' => MasterJurusan::class, 'targetAttribute' => ['Jurusan_id' => 'id']],
            [['Kelas_id'], 'exist', 'skipOnError' => true, 'targetClass' => KelasSiswa::class, 'targetAttribute' => ['Kelas_id' => 'id']],
            //[['MasaBerlaku_id'], 'exist', 'skipOnError' => true, 'targetClass' => MasaBerlakuAnggota::class, 'targetAttribute' => ['MasaBerlaku_id' => 'id']],
            [['Sex_id'], 'exist', 'skipOnError' => true, 'targetClass' => JenisKelamin::class, 'targetAttribute' => ['Sex_id' => 'ID']],
            [['UnitKerja_id'], 'exist', 'skipOnError' => true, 'targetClass' => Departments::class, 'targetAttribute' => ['UnitKerja_id' => 'ID']],
            [['JenjangPendidikan_id'], 'exist', 'skipOnError' => true, 'targetClass' => MasterJenjangPendidikan::class, 'targetAttribute' => ['JenjangPendidikan_id' => 'ID']],
    ...
    {
        return $this->hasOne(\common\models\MasterProgramStudi::class, ['id' => 'ProgramStudi_id']);
    }
    ...
    {
        return $this->hasOne(\common\models\Membersonline::class, ['NoAnggota' => 'MemberNo']);
    }
